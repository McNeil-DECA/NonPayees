...
public class Main { 
    public static void main(String[] args) throws Exception {
        ...
        PrintWriter pw1 = new PrintWriter("MNotPayName.txt");
        PrintWriter pw2 = new PrintWriter("MNotPayEmail.txt");
        boolean found = false;
        for(int i = 0; i < memNames.size(); i++) {
            ...
            if(!found) {
                found = checkEmail(memEmails.get(i)[0], memEmails.get(i)[1], payEmails);
            }
    ...
    public static boolean checkEmail(String email1, String email2, ArrayList<String> payEmails) {
        for(String str : payEmails) {
            // System.out.println(str);
            if(email1.equals(str) || email2.equals(str)) {
                System.out.println("Found email match for " + email1);
                return true;
            }
        }
        return false;
